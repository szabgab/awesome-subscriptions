...
* [Graceful Dev](https://graceful.dev/courses/) - (formerly Ruby Tapas) by [Avdi Grimm](https://avdi.codes/)
...
* [MasterClass](https://www.masterclass.com/) (not really programming related)
* [Creative Live](https://www.creativelive.com/) discontinued
...
See also the [Learnopoly reviews](https://learnopoly.com/)
...
* [Life Michael](https://academy.lifemichael.com/he/) - Individual courses in Python, Java, JavaScript, and TypeScript.
* [Coding with Saar](https://www.codingwithsaar.co.il/) - NodeJS, JavaScript, React, TypeScript, Clean Code, Next.js, git, HTML5, CSS3.
